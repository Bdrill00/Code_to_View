...
p_mat = positions['Mc_Vars']

pos   = p_mat[0]+7
c = jnp.zeros((A_mat.shape[1],1)).at[pos].set(1)

np.savetxt("./matrices/c.csv", c, delimiter=",")
np.savetxt("./matrices/xl.csv", all_lower, delimiter=",")
np.savetxt("./matrices/xu.csv", all_upper, delimiter=",")

np.savetxt("./matrices/A_eq.csv", A_mat, delimiter=",")
np.savetxt("./matrices/b_eq.csv", b_vec, delimiter=",")

np.savetxt("./matrices/A_ineq.csv", MC_mat, delimiter=",")
np.savetxt("./matrices/b_ineq.csv", b_mc,   delimiter=",")
